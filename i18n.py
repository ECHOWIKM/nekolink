...
DICT: Dict[str, Dict[str, str]] = {
    ...
    "dest_subtitle": {
        "zh": "选择并配置消息推送目标",
        "en": "Choose and configure push destinations",
        "ja": "転送先を選択して設定",
    },
    "dest_config_title": {"zh": "配置", "en": "Configure", "ja": "設定"},
    "dest_configured": {"zh": "已配置", "en": "Configured", "ja": "設定済み"},
    "dest_not_configured": {"zh": "未配置", "en": "Not configured", "ja": "未設定"},
    "dest_enabled": {"zh": "已启用", "en": "Enabled", "ja": "有効"},
    "dest_disabled": {"zh": "未启用", "en": "Disabled", "ja": "無効"},
    "dest_select_hint": {
        "zh": "👈 请在左侧选择一个推送服务进行配置",
        "en": "👈 Select a push service on the left to configure",
        "ja": "👈 左の転送先を選択して設定してください",
    },
    ...
    "home_run_card": {"zh": "实例运行控制", "en": "Instance control", "ja": "インスタンス制御"},
    "home_stats_card": {"zh": "通知统计", "en": "Notification stats", "ja": "通知統計"},
    "home_stats_total": {
        "zh": "程序启动以来总接收通知：",
        "en": "Total notifications since launch:",
        "ja": "起動以来の受信通知：",
    },
    "home_stats_today": {
        "zh": "今日收到通知：",
        "en": "Notifications today:",
        "ja": "本日の通知：",
    },
    "home_stats_unit": {"zh": "条", "en": "", "ja": "件"},
    "home_status_running": {"zh": "已运行", "en": "Running", "ja": "実行中"},
    "home_status_stopped": {"zh": "已停止", "en": "Stopped", "ja": "停止中"},
    "home_ble_status": {"zh": "蓝牙连接状态", "en": "Bluetooth", "ja": "Bluetooth"},
    "home_preview_hint": {
        "zh": "（双击通知查看完整原文）",
        "en": "(Double-click a notification for full text)",
        "ja": "（通知をダブルクリックで全文表示）",
    },
    "home_page_subtitle": {
        "zh": "iPhone 通知实时转发中心",
        "en": "iPhone notification forwarding hub",
        "ja": "iPhone 通知転送ハブ",
    },
    "home_recent": {"zh": "最近通知", "en": "Recent notifications", "ja": "最近の通知"},
    "home_targets": {"zh": "推送目标", "en": "Push targets", "ja": "転送先"},
    "home_no_notices": {"zh": "暂无通知", "en": "No notifications yet", "ja": "通知はありません"},
    "home_target_on": {"zh": "已启用", "en": "Enabled", "ja": "有効"},
    "home_target_off": {"zh": "未启用", "en": "Disabled", "ja": "無効"},
